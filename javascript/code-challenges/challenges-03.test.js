...
const typeNum = (arr) => {
  // Solution code here...
  const onlyNums = arr.filter(nums => 'number' === typeof(nums));
  return onlyNums;
...
const containsAnd = (arr) => {
  // Solution code here...
  const andArray = arr.filter( words => words.includes('and'));
  return andArray;
...
const oddValues = (arr) => {
  // Solution code here...
  let oddNums = arr.filter( nums => nums % 2 === 1 );
  return oddNums;
};
...
const getBaseStatGreaterThan = (arr, minBaseStat) => {
  // Solution code here...
  return arr.filter(stateObject => stateObject.baseStat > minBaseStat);
};
...
const getStatName = (arr, minBaseStat) => {
  // Solution code here...
  return arr.filter(stateObject => stateObject.baseStat > minBaseStat).map(currentStat => currentStat.state.name);
};
